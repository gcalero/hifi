...
JNIEXPORT void
Java_io_highfidelity_hifiinterface_InterfaceActivity_nativeOnCreateGvrSetup(JNIEnv *env,
                                                                            jobject obj,
                                                                            jobject instance,
...
JNIEXPORT void
Java_io_highfidelity_hifiinterface_InterfaceActivity_nativeOnExitVr(JNIEnv *env, jobject obj) {
...
void notifyEnterVr() {
    __interfaceActivity.callMethod<void>("enterVr", "()V");
}

void openUrlInAndroidWebView(QString urlString) {
    __interfaceActivity.callMethod<void>("openUrlInAndroidWebView", "(Ljava/lang/String;)V",
